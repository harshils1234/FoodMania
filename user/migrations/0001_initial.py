"""This file is migration file of user app."""
...
class Migration(migrations.Migration):
    """
    This class is migration class for user and user address model.
    """
    initial = True
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('m', 'Male'), ('f', 'Female'),
                                                                 ('o', 'Other')], max_length=1)),
                ('birth_date', models.DateField(blank=True, null=True)),
                ('image', models.ImageField(default='user_images/default_profile_image.jpg',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pincode', models.CharField(
                    max_length=6, validators=[django.core.validators.validate_integer])),
                ('city', models.CharField(max_length=100)),
                ('state', models.CharField(max_length=50)),
                ('type',
                 models.CharField(choices=[('Home', 'Home'), ('Work', 'Work'),
                                           ('Other', 'Other')], max_length=5)),
